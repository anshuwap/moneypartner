...
class DistributorOutletCreateValidation extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'outlet_gst_number'  => 'nullable|max:30|min:2',
            'account_status'     => 'required',
            'retailer_name'      => 'required|string|min:2|max:30',
            'mobile_no'          => 'required|numeric|unique:outlets|not_in:0|digits:10',
            'email'              => 'required|email|unique:users|min:2|max:30',
