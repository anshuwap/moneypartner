  ...
  <div class="col-12 mt-2">
    <div class="card">
      <div class="card-header">
        <h3 class="card-title">Recharge Charges List</h3>
      ...
      <div class="card-body table-responsive py-4">
        <table id="table" class="table table-hover table-sm text-nowrap">
          ...
          <tbody>
            ...
            $i =0;
            @endphp
            @foreach($recharge_charges as $key=>$bank)
            <tr>
              <td>{{ ++$i }}</td>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Recharge Charges/Commission</h5>
      ...
      <div class="modal-body" id="bank_charges">
        ...
        <form id="add_bank_charges" action="{{ url('admin/add-recharge-charges') }}" method="post">
          @csrf
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="form-row">
                <div class="form-group col-md-6">
                  <label>Type</label>
                  <select class="form-control form-control-sm" readonly id="type" required name="type">
...
<script>
  $('#add_bank_charges').click(function(e) {
    ...
    let url = '{{ url("admin/add-recharge-charges") }}';
    $('#heading_bank').html('Add Recharge Charges');
    $('#put').html('');
  ...
  $(document).on('click', '.edit_bank_account', function(e) {
    ...
    var url = "{{ url('admin/edit-recharge-charges') }}/" + id;
    $.ajax({
      url: url,
      method: 'GET',
      dataType: "JSON",
      ...
      success: function(res) {
        ...
        let urlU = '{{ url("admin/update-recharge-charges") }}';
        $('#heading_bank').html('Edit Recharge Charges');
  ...
  $(document).on('click', '.activeVer', function() {
    ...
    $.ajax({
      'url': "{{ url('admin/recharge-charges-status') }}/" + id + "/" + key + "/" + val,
      data: {},
      type: 'GET',
      dataType: 'json',
      success: function(res) {
