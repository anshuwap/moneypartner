            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-md-2">
                        ...
                        @if(!empty($filter))
                        <a href="javascript:void(0);" class="btn btn-sm bg-fuchsia color-palette " id="filter-btn"><i class="far fa-times-circle"></i>&nbsp;Close</a>
                        @else
                        <a href="javascript:void(0);" class="btn btn-sm bg-fuchsia color-palette " id="filter-btn"><i class="fas fa-filter"></i>&nbsp;Filter</a>
                        @endif
                        <a href="{{ url('admin/a-transaction-export') }}{{ !empty($_SERVER['QUERY_STRING'])?'?'.$_SERVER['QUERY_STRING']:''}}" class="btn btn-sm btn-warning mr-2"><i class="fas fa-cloud-download-alt"></i>&nbsp;Export</a>
