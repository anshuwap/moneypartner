        ...
        <div class="card">
            <div class="">
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li class="nav-item">
                        <a href="{{ url('admin/a-offline-payout') }}" class="nav-link active"><i class="fas fa-hand-holding-usd"></i> &nbsp;Payout Offline</a>
                    </li>
                </ul>
<div class="add-btn w-50">
                    <form action="{{ url('admin/a-offline-payout') }}" method="GET">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="approve_trans" action="{{ url('admin/a-offline-payout') }}" method="post">
                    @csrf
                    <div class="row">
                        <div class="col-md-12">
