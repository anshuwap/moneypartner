    ...
    <div class="card">
        ...
        <div class="row">
          ...
          <div class="col-md-2 d-flex">
            <div>
              ...
              @endif
              <a href="{{ url('distributor/pending-topup-export') }}{{ !empty($_SERVER['QUERY_STRING'])?'?'.$_SERVER['QUERY_STRING']:''}}" class="btn btn-sm btn-success mr-2"><i class="fas fa-cloud-download-alt"></i>&nbsp;Export</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row pl-2 pr-2" id="filter" <?= (empty($filter)) ? "style='display:none'" : "" ?>>
        <div class="col-md-12 ml-auto">
          <form action="{{ url('distributor/pending-topup') }}">
            <div class="form-row">
              ...
              <div class="form-group mt-4">
                ...
                <a href="{{ url('distributor/pending-topup') }}" class="btn btn-danger btn-sm"><i class="fas fa-eraser"></i>&nbsp;Clear</a>
              </div>
            </div>
          </form>
        </div>
