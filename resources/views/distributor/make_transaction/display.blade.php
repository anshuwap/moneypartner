...
@section('content')
@section('page_heading', 'distributor List')
        ...
        <div class="card">
            ...
            <div class="card-header">
                ...
                <div class="card-tools">
                    ...
                    <a href="{{ url('distributor/transaction-export') }}{{ !empty($_SERVER['QUERY_STRING'])?'?'.$_SERVER['QUERY_STRING']:''}}" class="btn btn-sm btn-success"><i class="fas fa-cloud-download-alt"></i>&nbsp;Export</a>
                    @if(!empty($filter))
            ...
            <div class="row pl-2 pr-2" id="filter" <?= (empty($filter)) ? "style='display:none'" : "" ?>>
                <div class="col-md-12 ml-auto">
                    <form action="{{ url('distributor/make-transaction') }}">
                        <div class="form-row">
                            ...
                            <div class="form-group mt-4">
                                ...
                                <a href="{{ url('distributor/make-transaction') }}" class="btn btn-danger btn-sm"><i class="fas fa-eraser"></i>&nbsp;Clear</a>
                            </div>
                        </div>
                    </form>
                </div>
...
@include('distributor.make_transaction.dmt')
@include('distributor.make_transaction.payout')
