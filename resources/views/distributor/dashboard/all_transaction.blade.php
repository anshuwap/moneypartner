      ...
      <div class="modal-dialog modal-dialog-centered" id="preview-modal" role="document">
          <div class="modal-content">
              ...
              <div class="modal-body pl-2 pr-2">
                  <div id="import-file">
                      <p>Download sample Payout Transaction Import(CSV) file : <a href="{{ url('distributor/export') }}" class="text-green">Download</a></p>
                      <form id="import" action="{{ url('distributor/import') }}" method="post" enctype="multipart/form-data">
                          @csrf
  ...
  <script>
      $('#import').click(function(e) {
          e.preventDefault();
          $('form#import')[0].reset();
          let url = '{{ url("distributor/import") }}';
      ...
      $('#mode').change(function() {
          var mode = $(this).val();
          location.href = '{{ url("distributor/dashboard") }}?mode=' + mode;
      })
