                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <table class="table table-sm">
                        ...
                        <tr>
                          <th>Address Proff:</th>
                          <td>{{ ucfirst($outlet->address_proff) }}</td>
                        </tr>
                        <tr>
                          <th>Pancard No :</th>
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          <div class="card p-2"><strong>{{ ucwords(str_replace('_',' ',$outlet->id_proff)) }}</strong>
                            <img src="{{ (!empty($outlet->upload_id))?asset('attachment/').'/'.$outlet->upload_id:asset('assets').'/dist/img/user4-128x128.jpg' }}">
                          </div>
                        </div>

                        <div class="col-md-12">
                          <div class="card p-2"><strong>Address Proff</strong>
                            <img src="{{ (!empty($outlet->upload_address))?asset('attachment/').'/'.$outlet->upload_address:asset('assets').'/dist/img/user4-128x128.jpg' }}">
                          </div>
                        </div>
                      </div>
                    </div>
