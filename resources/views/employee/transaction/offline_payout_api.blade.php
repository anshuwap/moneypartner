...
<div class="add-btn w-50">
                    <form action="{{ url('employee/e-offline-payout') }}" method="GET">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="approve_trans" action="{{ url('employee/e-offline-payout') }}" method="post">
                    @csrf
                    <div class="row">
                        <div class="col-md-12">
...
<script>
    ...
    $(document).on('click', '.view', function() {
        ...
        $.ajax({
            url: "<?= url('employee/e-offline-payout-detail') ?>",
            data: {
                'id': _id,
            },
            type: 'GET',
    ...
    $('#status-select').change(function(e) {
        ...
        if (type == '') {
            ...
            $.ajax({
                url: "<?= url('employee/e-offline-payout-comment') ?>",
                data: {
                    'type': type
                },
                type: 'GET',
