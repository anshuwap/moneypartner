      ...
      <div class="modal-dialog modal-dialog-centered" id="preview-modal" role="document">
          <div class="modal-content">
              ...
              <div class="modal-body pl-2 pr-2">
                  <div id="import-file">
                      <p>Download sample Payout Transaction Import(CSV) file : <a href="{{ url('employee/export') }}" class="text-green">Download</a></p>
                      <form id="import" action="{{ url('employee/import') }}" method="post" enctype="multipart/form-data">
                          @csrf
  ...
  <script>
      ...
      $('#mode').change(function() {
          var mode = $(this).val();
          location.href = '{{ url("employee/dashboard") }}?mode=' + mode;
      })
