  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" id="allocate_retailer">
        <form id="allocate_retailer_account" action="{{ url('employee/u-save-allocate-retailer') }}" method="post">
          @csrf
          <div class="row">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" id="upi-id">
                <form id="add_upi_id" action="{{ url('employee/upi') }}" method="post">
                    @csrf
                    <div id="put"></div>
                    <div class="row">
                        <div class="col-md-12">
...
<script>
  $(document).on('click', '.allocate-retailer', function(e) {
    ...
    var url = "{{ url('employee/u-allocate-retailer') }}";
    $.ajax({
      url: url,
      method: 'GET',
      dataType: "JSON",
...
<script>
    ...
    $(document).on('click', '.edit_upi_id', function(e) {
        e.preventDefault();
        var id = $(this).attr('upi_id_id');
        var url = "{{ url('employee/upi') }}/" + id + "/edit";
        $.ajax({
            url: url,
            method: 'GET',
            dataType: "JSON",
