    ...
    <div class="card">
        ...
        <div class="row">
          ...
          <div class="col-md-2 d-flex">
            <div>
              ...
              @endif
              <a href="{{ url('employee/pending-topup-export') }}{{ !empty($_SERVER['QUERY_STRING'])?'?'.$_SERVER['QUERY_STRING']:''}}" class="btn btn-sm btn-success mr-2"><i class="fas fa-cloud-download-alt"></i>&nbsp;Export</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row pl-2 pr-2" id="filter" <?= (empty($filter)) ? "style='display:none'" : "" ?>>
        <div class="col-md-12 ml-auto">
          <form action="{{ url('employee/pending-topup') }}">
            <div class="form-row">
