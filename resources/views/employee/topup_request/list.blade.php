    ...
    <div class="card">
        ...
        <div class="row">
          ...
          <div class="col-md-2 d-flex">
            <div>
              ...
              @endif
              <a href="{{ url('employee/topup-list-export') }}{{ !empty($_SERVER['QUERY_STRING'])?'?'.$_SERVER['QUERY_STRING']:''}}" class="btn btn-sm btn-success mr-2"><i class="fas fa-cloud-download-alt"></i>&nbsp;Export</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row pl-2 pr-2" id="filter" <?= (empty($filter)) ? "style='display:none'" : "" ?>>
        <div class="col-md-12 ml-auto">
          <form action="{{ url('employee/topup-list') }}">
            <div class="form-row">
              ...
              <div class="form-group mt-4">
                ...
                <a href="{{ url('employee/topup-list') }}" class="btn btn-danger btn-sm"><i class="fas fa-eraser"></i>&nbsp;Clear</a>
              </div>
            </div>
          </form>
        </div>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form action="{{ url('employee/topup-request') }}" id="topup-request" method="post">
...
<script>
  $(document).ready(function() {
    ...
    $('.view-topup-request').click(function() {
      ...
      $.ajax({
        url: "{{ url('employee/topup-request-details') }}/" + topup_id,
        type: 'GET',
        dataType: 'JSON',
        success: function(res) {
    ...
    $(document).on('click', '#update_payment_channel', function() {
      ...
      $.ajax({
        ...
        type: "GET",
        url: '{{ url("employee/topup-payment-channel") }}',
        dataType: 'json',
        beforeSend: function() {
