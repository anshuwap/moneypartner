    ...
    <div class="card">
      <div class="card-header">
        ...
        <div class="card-tools">
          ...
          <a href="{{ url('employee/outlets/create') }}" class="btn btn-sm btn-success mr-2"><i class="fas fa-plus-circle"></i>&nbsp;Add</a>
        </div>
      </div>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Download sample lead Import(CSV) file : <a href="{{ url('employee/order-sample') }}" class="text-green">Download</a></p>
        <form id="import_form" action="{{ url('employee/outlet-import') }}" method="post">
          @csrf
...
<script>
  ...
  $('#import').click(function(e) {
    ...
    let url = '{{ url("employee/outlet-import") }}';
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $(document).on('click', '.activeVer', function() {
      ...
      $.ajax({
        'url': "{{ url('employee/outlets-status') }}",
        data: {
          "_token": "{{ csrf_token() }}",
          'id': id,
          'status': val
...
<div class="modal fade" id="assignModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="assignOutlet" action="{{ url('employee/assign-outlet') }}" method="post">
          @csrf
