...
<div id="outlet">
    ...
    <form id="add-outlet" action="{{ url('employee/outlets') }}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="row">
                ...
                <div class="card card-secondary">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control form-control-sm" name="security_amount" placeholder="Security Amount">
