    ...
    <div class="card">
      <div class="card-header">
        ...
        <div class="card-tools">
          ...
          <a href="{{ url('employee/outlets') }}" class="btn btn-sm btn-warning"><i class="fas fa-arrow-alt-circle-left"></i>&nbsp;Back</a>
        </div>
      </div>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" id="bank_charges">
        ...
        <form id="add_bank_charges" action="{{ url('employee/outlet-add-bank-charges') }}" method="post">
          @csrf
...
<script>
  $('#add_bank_charges').click(function(e) {
    ...
    let url = '{{ url("employee/outlet-add-bank-charges") }}';
  ...
  $(document).on('click', '.edit_bank_account', function(e) {
    ...
    var url = "{{ url('employee/outlet-edit-bank-charges') }}/" + id;
    $.ajax({
      url: url,
      method: 'GET',
      dataType: "JSON",
      ...
      success: function(res) {
        ...
        let urlU = '{{ url("employee/outlet-update-bank-charges") }}';
  ...
  $(document).on('click', '.activeVer', function() {
    ...
    $.ajax({
      'url': "{{ url('employee/outlet-charges-status') }}/" + id + "/" + key + "/" + val,
      data: {},
      type: 'GET',
      dataType: 'json',
      success: function(res) {
