...
<div id="outlet">
    ...
    <form id="edit-outlet" action="{{ url('employee/outlets/'.$outlet->_id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card card-secondary">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control form-control-sm" value="{{ $outlet->security_amount }}" name="security_amount" placeholder="Security Amount">
                            <span id="security_amount_msg" class="custom-text-danger"></span>
                        </div>
                        ...
                        <div class="">
                            ...
                            <a href="{{ url('employee/outlets') }}" class="btn btn-sm btn-warning">Back</a>
                        </div>
                    </div>
                    <!-- /.card-body -->
